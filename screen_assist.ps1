...
$lblIdle.Text     = "Idle time:"
$lblIdle.AutoSize = $true
$lblIdle.Location = New-Object System.Drawing.Point(20, 116)

$cmbIdle = New-Object System.Windows.Forms.ComboBox
...
$timer.Add_Tick({
    ...
    $currentIdleTimeout = switch ($cmbIdle.SelectedItem) {
        "5 seconds"  { 5 }
        "10 seconds" { 10 }
        "30 seconds" { 30 }
        "60 seconds" { 60 }
